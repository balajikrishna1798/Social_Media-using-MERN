...
export const registerr: any = createAsyncThunk(
  "auth/registerr",
  async (data: any, { rejectWithValue }) => {
    const { formData, navigate } = data;
    try {
...
export const usersProfile: any = createAsyncThunk(
  "auth/usersProfile",
...
export const getConversation: any = createAsyncThunk(
...
export const googleSignIn: any = createAsyncThunk(
  "auth/googleSignIn",
  async (data: any, { rejectWithValue }) => {
